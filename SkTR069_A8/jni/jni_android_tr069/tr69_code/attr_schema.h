...
struct evcpe_attr_schema
{
	...
	char *name;  //name="InternetGatewayDevice"   属性的名字
	enum evcpe_type type; // object or multiobject  or something else
	int extension;
	int inform;
    enum evcpe_param_info_visible visible;
