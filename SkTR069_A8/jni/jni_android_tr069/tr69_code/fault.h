...
enum evcpe_fault_code {
	...
	EVCPE_CPE_METHOD_NOT_SUPPORTED = 9000,							//Method not supported
	EVCPE_CPE_REQUEST_DENIED = 9001,                                //Request denied (no reason specified)
	EVCPE_CPE_INTERNAL_ERROR = 9002,							    //Internal error
	EVCPE_CPE_INVALID_ARGUMENTS = 9003,								//client:Invalid arguments
	EVCPE_CPE_RESOUCES_EXCEEDS = 9004,								//Resources exceeded
	EVCPE_CPE_INVALID_PARAM_NAME = 9005,							//client:Invalid parameter name
	EVCPE_CPE_INVALID_PARAM_TYPE = 9006,							//client:Invalid parameter type
	EVCPE_CPE_INVALID_PARAM_VALUE = 9007,							//client:Invalid parameter value
	EVCPE_CPE_NON_WRITABLE_PARAM = 9008,							//client:Attempt to set a non-writable parameter
